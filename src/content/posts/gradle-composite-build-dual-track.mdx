...
我给两个自家 KMP 库（[loginbase-kt](https://github.com/HarlonWang/loginbase-kt) 登录底座、[eventbase-kt](https://github.com/HarlonWang/eventbase-kt) 埋点客户端）和消费方 App [TrendingAI](https://github.com/HarlonWang/TrendingAI) 接的就是这套双轨。最终的状态是：
